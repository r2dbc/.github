...
This project is a https://www.reactive.foundation/[Reactive Foundation] project governed by the link:CODE_OF_CONDUCT.adoc[R2DBC Code of Conduct].
...
1. You must have the right to submit code changes. R2DBC follows https://developercertificate.org/[Developer Certificate of Origin (DCO)] rules. Commit messages must contain a `Signed-off-by` line. Git even has a `-s` command line option to append this automatically to your commit message:
+
----
